...
<div id="page" onmouseup="EndDrag(this)" onmousemove="OnDrag(event)" style="grid-template-areas: 'middlecolT middlecolT middlecolT middlecolT middlecolT dragbarVB middlecolM' 
		...
		<div class="container-fluid h-100" style="padding: 5px;">
			<div class="row" id="topHeader" style="padding-bottom: 5px;">
				<div class="d-flex align-items-center d-flex">
					...
					<label class="form-label d-flex align-items-center m-0 me-1 h-100">~</label>
					<input type="date" max="9999-12-31" class="form-control w-auto h-100 me-1" id="endDate"> 
					<select class="form-select w-auto h-100 me-1 approvalSel" id="approvalSel">
						<option value="">전체</option>
...
<!-- 							<th class="text-center align-middle"><span id="basicCarry"></span><br>기초이월잔액</th> -->
<!-- 							<th class="text-center align-middle">계산서발행액</th> -->
<!-- 							<th class="text-center align-middle">계산서미발행</th> -->
<!-- 							<th class="text-center align-middle">수금합계</th> -->
<!-- 							<th class="text-center align-middle">미수금</th> -->
<!-- 							<th class="text-center align-middle"><span id="beforePub"></span><br>계산서발행액</th>							 -->
<!-- 							<th class="text-center align-middle"><span id="afterPub"></span><br>계산서발행액</th> -->
<!-- 							<th class="text-center align-middle">수주잔액<br>(수주-계산서발행)</th> -->
<!-- 							<th class="text-center align-middle">미수잔액<br>(계산서-수금)</th> -->
<!-- 							<th class="text-center align-middle">미완료잔액<br>(수주-수금계)</th> -->
<!-- 							<th class="text-center align-middle">수금예정검산<br>(미완료-수금예정합)</th> -->
							
<!-- 							<th class="text-center align-middle">SerialNo</th> -->
						</tr>
					</thead>
					<tfoot>
						<tr style="background-color: #6fdb65;">
							<td colspan='11' style="background-color: #6fdb65;">전체합계</td>
...
<!-- 							<td style="background-color: #6fdb65;"></td> -->
<!-- 							<td id="totalPublishedAmt" style="background-color: #6fdb65;"></td> -->
...
<!-- 							<td id="totalCollectPreCheck" style="background-color: #6fdb65;"></td> -->
<!-- 							<td style="background-color: #6fdb65;"></td> -->
...
<!-- 					</div> -->
							<div class="row" id="leftHeader">
								<div class="d-flex align-items-center justify-content-space-between w-100"
									...
									<label class="form-label d-flex align-items-center header-label m-0 me-1 h-100">매출정보</label>
<!-- 									<div class="btn-group me-3" role="group" -->
<!-- 										aria-label="Small button group"> -->
<!-- 										<button type="button" class="btn btn-outline-light w-auto" -->
...
<!-- 									</div> -->
									...
									<div class="btn-group" role="group"
										aria-label="Small button group">
										<button type="button" class="btn btn-outline-light w-auto"
											style="font-size: 18px !important;" id="btnSalesNew"
											disabled>
											<i class="fa-solid fa-plus"></i>
										</button>
<!-- 										<button type="button" class="btn btn-outline-light w-auto" -->
...
<!-- 										</button> -->
										<button type="button" class="btn btn-outline-light w-auto"
											style="font-size: 20px !important;" id="btnSalesSave"
											disabled>
											<i class="fa-regular fa-floppy-disk"></i>
										</button>
										<button type="button" class="btn btn-outline-light w-auto"
											style="font-size: 18px !important;" id="btnSalesEdit"
											disabled>
											<i class="fa-regular fa-pen-to-square"></i>
										</button>
										<button type="button" class="btn btn-outline-danger w-auto"
											style="font-size: 17px !important;" id="btnSalesDel"
											disabled>
											<i class="fa-solid fa-trash-can"></i>
										</button>
										<button type="button" class="btn btn-outline-light w-auto"
	...
	<div id="middlecolB" style="max-height:42vh;">
		<div class="container-fluid h-100" style="padding: 5px;">
			<div class="row" id="middleHeader" style="padding-bottom: 5px;">
				<div class="d-flex align-items-center d-flex">
					<label class="form-label d-flex align-items-center header-label m-0 me-1 h-100">수금정보</label>
				</div>
				<div class="me-lg-auto"></div>
				<div class="btn-group" role="group" aria-label="Small button group">
					<button type="button" class="btn btn-outline-light w-auto newBtn" style="font-size: 18px !important;" id="btnCollectNew" disabled>
						<i class="fa-solid fa-plus"></i>
					</button>
					<button type="button" class="btn btn-outline-light w-auto" style="font-size: 20px !important;" id="btnCollectSave" disabled>
						<i class="fa-regular fa-floppy-disk"></i>
					</button>
					<button type="button" class="btn btn-outline-light w-auto editBtn" style="font-size: 18px !important;" id="btnCollectEdit" disabled>
						<i class="fa-regular fa-pen-to-square"></i>
					</button>
					<button type="button" class="btn btn-outline-danger w-auto delBtn" style="font-size: 17px !important;" id="btnCollectDel" disabled>
						<i class="fa-solid fa-trash-can"></i>
					</button>
					<button type="button" class="btn btn-outline-light w-auto" style="font-size: 20px !important;" id="btnCollectCancel" disabled>
						<i class="fa-solid fa-xmark"></i>
					</button>
				</div>
			</div>
			<div class="row" id="rightBody">
				<table class="table table-bordered p-0 m-0" id="bizOrderCollectTable">
					<thead class="table-light">
						<tr>
							<th class="text-center align-middle">항목</th>
		...
		<div class="container-fluid h-100" style="padding: 5px; width: 100%;">
			<div class="row" id="rightHeader" style="padding-bottom: 5px;">
				<div class="d-flex align-items-center justify-content-end w-100"
					style="margin-bottom: 5px;">
					<div class="d-flex align-items-center d-flex">
						<label class="form-label d-flex align-items-center header-label m-0 me-1" style="height:32px;">지급정보</label>
					</div>
					<div class="me-lg-auto"></div>
					<div class="btn-group" role="group" 
							aria-label="Small button group">
...
<!-- 										<input type="hidden" class="inputGroup" id="goodsNmIdx" name="goodsNmIdx"> -->
							...
							<tr>
								<th class="text-center align-middle"><span
									style="color: #ff0000;">*</span>수량</th>
								<td class="text-center align-middle"><input type="text"
									class="form-control text-end inputGroup" id="bizOrdQty" disabled></td>
								<th class="text-center align-middle"><span
									style="color: #ff0000;">*</span>단가</th>
								<td class="text-center align-middle"><input type="text"
									class="form-control text-end inputGroup" id="bizOrdCost" disabled></td>
								<th class="text-center align-middle"><span
									style="color: #ff0000;">*</span>수주금액</th>
								<td class="text-center align-middle" colspan="3"><input type="text"
									class="form-control text-end inputGroup" id="bizOrdAmt" disabled></td>
<!-- 								<th class="text-center align-middle"><span -->
...
<!-- 제품명 모달 끝 -->
<!-- 프로젝트 채번 모달 -->
<div class="modal fade" id="prjCdModal" tabindex="-1"
	aria-hidden="true" style="z-index: 9999;">
	<div class="modal-dialog" style="max-width: 80vw;">
		<div class="modal-content">
			...
			<div class="row modal-body-top text-center mt-2" style="justify-content:space-between;">
				<div class="me-lg"></div>
				<span id="prjNumberMake" style="font-size:40px;height:6vh;margin-left:100px;">__-_____-_-__</span>
				...
				<div class="row">
					<div id="leftcol" style="width:25%;">
						<div class="container-fluid h-100" style="padding: 3px;">
							<div class="row">
								<table class="table table-bordered p-0 m-0" id="prjTable" style="width:100%;">
									<thead class="table-light">
										<tr>
					...
					<div id="centercol" style="width:25%;">
						<div class="container-fluid h-100" style="padding: 3px;">
							<div class="row">
								<table class="table table-bordered p-0 m-0" id="prdTypeTable" style="width:100%;">
									<thead class="table-light">
										<tr>
					...
					<div id="rightcol" style="width:25%;">
						<div class="container-fluid h-100" style="padding: 3px;">
							<div class="row">
								<table class="table table-bordered p-0 m-0" id="prdGroupTable" style="width:100%;">
									<thead class="table-light">
										<tr>
...
<script>
	...
	let salesRecogGubunList = getCommonCode('시스템', '045'); // 매출구분
	...
	let bizOrderAdmTable = $('#bizOrderAdmTable').DataTable({
        ...
        ajax : {
			...
			data : {
				...
				abroadGubun		: function() { return '001'; },
			},
		},
        rowId: 'idx',
		columns : [
...
// 			//상태
// 			{ data: 'confirmYn', className : 'text-center align-middle',
// 				render : function(data, type, row, meta) {
// 					if(data != null){
// 						if(data == 'Y'){
// 							return '<div style="white-space: nowrap; text-overflow: ellipsis; overflow: hidden;">승인대기</div>';
// 						} else if(data == 'N'){
// 							return '<div style="white-space: nowrap; text-overflow: ellipsis; overflow: hidden;"></div>';
// 						} else if(data == 'A'){
// 							return '<div style="white-space: nowrap; text-overflow: ellipsis; overflow: hidden;">승인</div>';
// 						}
// 					} else {
// 						return "";
// 					}
...
// 			//현재년도 기초이월잔액
// 			{ data: 'carriedAmt', className : 'text-end align-middle',
// 				render : function(data, type, row, meta) {
// 					if(data != null){
// 						return '<div style="white-space: nowrap; text-overflow: ellipsis; overflow: hidden;">'+addCommas(parseFloat(data))+'</div>';
// 					} else {
...
// 			},
// 			//계산서 발행액
// 			{ data: 'publishAmt', className : 'text-end align-middle',
// 				render : function(data, type, row, meta) {
// 					if(data != null){
// 						return '<div style="white-space: nowrap; text-overflow: ellipsis; overflow: hidden;">'+addCommas(parseFloat(data))+'</div>';
// 					} else {
...
// 			},
// 			//계산서미발행
// 			{ data: 'remainAmt', className : 'text-end align-middle',
// 				render : function(data, type, row, meta) {
// 					if(data != null){
// 						return '<div style="white-space: nowrap; text-overflow: ellipsis; overflow: hidden;">'+addCommas(parseFloat(data))+'</div>';
...
// 			},
// 			//수금합계
// 			{ data: 'collectAmt', className : 'text-end align-middle',
// 				render : function(data, type, row, meta) {
// 					if(data != null){
// 						return '<div style="white-space: nowrap; text-overflow: ellipsis; overflow: hidden;">'+addCommas(parseFloat(data))+'</div>';
// 					} else {
...
// 			},
// 			//미수금
// 			{ data: 'remainPublishAmt', className : 'text-end align-middle',
// 				render : function(data, type, row, meta) {
// 					if(data != null){
// 						return '<div style="white-space: nowrap; text-overflow: ellipsis; overflow: hidden;">'+addCommas(parseFloat(data))+'</div>';
...
// 			},
// 			//현재년도 이전 계산서발행액
// 			{ data: 'lastYearAmt', className : 'text-end align-middle',
// 				render : function(data, type, row, meta) {
// 					if(data != null){
// 						return '<div style="white-space: nowrap; text-overflow: ellipsis; overflow: hidden;">'+addCommas(parseFloat(data))+'</div>';
// 					} else {
...
// 			},
// 			//현재년도 이후 계산서발행액
// 			{ data: 'thisYearAmt', className : 'text-end align-middle',
// 				render : function(data, type, row, meta) {
// 					if(data != null){
// 						return '<div style="white-space: nowrap; text-overflow: ellipsis; overflow: hidden;">'+addCommas(parseFloat(data))+'</div>';
// 					} else {
...
// 			},
// 			//수주-수금계
// 			{ data: 'inCompleteAmt', className : 'text-end align-middle',
// 				render : function(data, type, row, meta) {
// 					if(data != null){
// 						return '<div style="white-space: nowrap; text-overflow: ellipsis; overflow: hidden;">'+addCommas(parseFloat(data))+'</div>';
...
// 			},
// 			//수금예정검산
// 			{ data: 'collectPreCheck', className : 'text-end align-middle',
// 				render : function(data, type, row, meta) {
// 					if(data != null){
// 						return '<div style="white-space: nowrap; text-overflow: ellipsis; overflow: hidden;">'+addCommas(parseFloat(data))+'</div>';
// 					} else {
...
// 			let totalPublishedAmt = 0;
// 			let totalremainAmt = 0;
// 			let totalCollectAmt = 0;
// 			let totalRemainPublishAmt = 0;
// 			let totalLastYearAmt = 0;
// 			let totalThisYearAmt = 0;
// 			let totalremainAmt1 = 0;
// 			let totalRemainPublishAmt1 = 0;
// 			let totalInCompleteAmt = 0;
// 			let totalCollectPreCheck = 0;

			for(var i=0;i<data.length;i++) {
				totalQty += parseFloat(data[i].ordQty==null?0:data[i].ordQty);
				totalOrdAmt += parseFloat(data[i].ordAmt==null?0:data[i].ordAmt);
// 				totalCarriedAmt += parseFloat(data[i].carriedAmt==null?0:data[i].carriedAmt);
// 				totalPublishedAmt += parseFloat(data[i].publishAmt==null?0:data[i].publishAmt);
// 				totalremainAmt += parseFloat(data[i].remainAmt==null?0:data[i].remainAmt);
// 				totalCollectAmt += parseFloat(data[i].collectAmt==null?0:data[i].collectAmt);
// 				totalRemainPublishAmt += parseFloat(data[i].remainPublishAmt==null?0:data[i].remainPublishAmt);
// 				totalLastYearAmt += parseFloat(data[i].lastYearAmt==null?0:data[i].lastYearAmt);
// 				totalThisYearAmt += parseFloat(data[i].thisYearAmt==null?0:data[i].thisYearAmt);
// 				totalInCompleteAmt += parseFloat(data[i].inCompleteAmt==null?0:data[i].inCompleteAmt);
// 				totalCollectPreCheck += parseFloat(data[i].collectPreCheck==null?0:data[i].collectPreCheck);
			}

			$('#totalQty').text(addCommas(totalQty));
			$('#totalOrdAmt').text(addCommas(totalOrdAmt));
// 			$('#totalCarriedAmt').text(addCommas(totalCarriedAmt));
// 			$('#totalPublishedAmt').text(addCommas(totalPublishedAmt));
...
// 			$('#totalCollectPreCheck').text(addCommas(totalCollectPreCheck));
...
// 		$('#btnGoodsTypeSelect').attr('disabled',false);
		$('#btnGoodsNmSelect').attr('disabled',false);   
// 		$('#customerDesc').attr('disabled',false);
// 		$('#abroadGubun').attr('disabled',false);
...
// 		$('#btnDealCorpSelect').attr('disabled',false);
	...
	$('#btnEditAdm').on('click', function() {
		...
		$('#bizOrdCost').val(addCommas(data.ordCost));
		$('#bizOrdAmt').val(addCommas(data.ordAmt));
		$('#bizOrdPrjCd').val(data.prjCd);
		$('#bizOrdPrjNm').val(data.prjNm);

		serialCnt = data.serialCnt;
...
// 				}
	...
	$('#bizOrderDtlTable tbody').on('click','tr', function() {
		...
		processInfoTable.ajax.reload(function(){
			...
			/*if( isEmptyCheck(processInfoTable.data().toArray()[0]) ){
				$('#btnWorkOrdConfirm').addClass('btn-outline-light');
				$('#btnWorkOrdConfirm').removeClass('btn-success');
			} else {
				if(parseInt(processInfoTable.data().toArray()[0].workOrdCnt) > 0){
					$('#btnWorkOrdConfirm').removeClass('btn-outline-light');
					$('#btnWorkOrdConfirm').addClass('btn-success');
				} else {
					$('#btnWorkOrdConfirm').addClass('btn-outline-light');
...
// 	$('#goodsNmModal').on('shown.bs.modal', function() {
// 		goodsNmModalTable.ajax.reload(function() {});
// 	});
...
// 		if($('#poNo').val() == '') {
// 			toastr.warning('고객발주No를 입력해주세요.');
// 			$('#poNo').focus();
// 			return false;
// 		}
// 		if($('#dueDate').val() == '') {
// 			toastr.warning('납기일을 선택해주세요.');
// 			$('#dueDate').focus();
// 			return false;
// 		}
		if($('#goodsNm').val() == '') {
...
// 		}
		...
		$.ajax({
            ...
            data: {
                ...
                'goodsNm'			:	$('#goodsNm').val(),
                'ordQty'			:	removeCommas($('#bizOrdQty').val()),
                'ordCost'			:	removeCommas($('#bizOrdCost').val()),
                'ordAmt'			:	removeCommas($('#bizOrdAmt').val()),
                'poDesc'			:	$('#poDesc').val(),
...
// 	});
	...
	//입고수량 숫자만 입력하게 처리
	$(document).on('keyup', "#bizOrdQty, #bizOrdCost, #bizOrdAmt, input[name=publishAmt], input[name=collectAmt]", function(event){
	...
	$(document).on('keyup', '#bizOrdQty, #bizOrdCost', function(){
		if($('#bizOrdQty').val() != '0' && $('#bizOrdQty').val() != '' && $('#bizOrdCost').val() != '0' && $('#bizOrdCost').val() != ''){
			var sum = 0;
			sum = parseInt(removeCommas($('#bizOrdQty').val())) * parseInt(removeCommas($('#bizOrdCost').val()));
			$('#bizOrdAmt').val(addCommas(sum));
		}
	});
	...
	$(document).on('change', 'input:checkbox[name=checkBox]', function(){
		if($(this).is(':checked')){
			...
			html += '	<td class="text-center align-middle" colspan="3">';
			html += '		<div name="'+$(this).attr('id')+'_prjBizOrdAmt">'+addCommas(parseFloat(data.ordAmt))+'</span>';
			html += '	</td>';
			html += '</tr>';
			html += '<tr class="'+$(this).attr('id')+'">';
			...
			let projectAmt = $('#projectAmt').val().replaceAll(/,/g, '');
			$('#projectAmt').val(addCommas(parseInt(projectAmt) + parseInt(data.ordAmt)));
// 			$('input[name=prjBizOrdQty]').attr('class', 'form-control text-end inputGroup');
			...
			let projectAmt = $('#projectAmt').val().replaceAll(/,/g, '');
			$('#projectAmt').val(addCommas(parseFloat(projectAmt) - (parseFloat($('div[name='+$(this).attr('id')+'_prjBizOrdAmt]').text().replaceAll(/,/g, '')))));
...
//  					$('#orderAddEditModal').modal('hide');
	...
	$('#projectCost').on('change', function(){
		...
		$('#projectAmt').val(addCommas(parseInt(qty) * parseInt(cost)));
	});
