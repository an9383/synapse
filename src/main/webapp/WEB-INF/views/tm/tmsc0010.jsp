		...
		<div class="container-fluid h-100" style="padding: 5px;">
			<div class="row" id="leftHeader" style="padding-bottom: 5px;">
				<div class="d-flex align-items-center d-flex">
					...
					<label class="form-label d-flex align-items-center header-label m-0 me-1 h-100">현재고 0 항목 제외</label>
				...
				<table class="table table-bordered p-0 m-0"	id="stockPaymentAdmTable">
					<thead class="table-light">
						<tr>
							...
							<th class="text-center align-middle" style="min-width:60px;">이월</th>
							<th class="text-center align-middle" style="min-width:60px;">입고</th>
							<th class="text-center align-middle" style="min-width:60px;">출고</th>
							<th class="text-center align-middle">조정입고</th>
							<th class="text-center align-middle">조정출고</th>
					...
					<tfoot id="stockPaymentAdmTableTfoot">
						<tr>
							...
							<th class="text-end align-middle" id="prevFoot"></th>
							<th class="text-end align-middle" id="inputFoot"></th>
							<th class="text-end align-middle" id="outputFoot"></th>
							<th class="text-end align-middle" id="inputMFoot"></th>
							<th class="text-end align-middle" id="outputMFoot"></th>
							<th class="text-end align-middle" id="resultFoot"></th>
						</tr>
					</tfoot>
				</table>
			</div>
...
<script>
	...
	let stockPaymentAdmTable = $('#stockPaymentAdmTable').DataTable({
		...
		columns : [
			...
			{ data: 'prev', className : 'text-end align-middle',name:'prev', //이월
				render : function(data, type, row, meta) {
					if(data != null && data != '') {
						...
						if(row['spGubun'] == '002'){//자재인경우
							...
							html += '<div class="text-end align-middle"style="white-space:nowrap;width:50%;">'+ returnR + '</div>';
			...
			{ data: 'input', className : 'text-end align-middle',name:'input', //입고
				render : function(data, type, row, meta) {
					if(data != null && data != '') {
						let returnR = '';
						if(row['spGubun'] == '002'){//자재인경우
			...
			{ data: 'output', className : 'text-end align-middle',name:'output', //출고
				render : function(data, type, row, meta) {
					if(data != null && data != '') {
						let returnR = '';
						if(row['spGubun'] == '002'){//자재인경우
			...
			{ data: 'inputM', className : 'text-end align-middle',name:'inputM', //조정입고
				render : function(data, type, row, meta) {
					if(data != null && data != '') {
						let returnR = '';
						if(row['spGubun'] == '002'){//자재인경우
			...
			{ data: 'outputM', className : 'text-end align-middle',name:'outputM', //조정출고
				render : function(data, type, row, meta) {
					if(data != null && data != '') {
						let returnR = '';
						if(row['spGubun'] == '002'){//자재인경우
			...
			{ className : 'text-end align-middle',name:'result', //현재고
				render : function(data, type, row, meta) {
					...
					if(row['spGubun'] == '002'){//자재인경우
						if(parseInt(data) < 0){
							returnR = "-" + parseInt(-1*result/500) + "R" + parseInt(-1*result%500); 
						} else {
							returnR = parseInt(result/500) + "R" + parseInt(result%500); 
						}
						let html = '<div class="row">';
						html += '<div class="text-end align-middle"style="white-space:nowrap;width:50%;">'+ returnR + '</div>';
						html += '<div class="text-end align-middle" style="white-space:nowrap;width:50%;">'+ addCommas(parseInt(result)) + '</div>';
						html += '</div>';
						return html;
					} else {
						return addCommas(parseInt(result));
					}
