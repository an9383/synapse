...
<% 
	...
	//검색 API 승인키(개발용) : devU01TX0FVVEgyMDIxMTAwODIwMjYwMzExMTczOTk=
	//검색 API 승인키(운영용) : U01TX0FVVEgyMDIxMTAxMTEwNTAzMzExMTc0MTY=
	//모바일팝업 API 승인키(운영용) : U01TX0FVVEgyMDIxMTAxMTEwNTIxNjExMTc0MTc=
	String confmKey = "U01TX0FVVEgyMDIxMTAxMTEwNTAzMzExMTc0MTY="; // 검색API 승인키
	...
	<form name="AKCFrm" id="AKCFrm" method="post">
		...
		<div class="pop-address-search" style="width: 100%;" >
			...
			<div style="height: 365px;" id="searchContentBox">
				...
				<p class="guide">검색어 예 : 도로명(반포대로 58), 건물명(독립기념관), 지번(삼성동 25)</p>
