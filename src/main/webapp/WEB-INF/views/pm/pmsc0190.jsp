				...
				<table class="table table-bordered p-0 m-0" id="purchaseOrderAdmTable">
					...
					<tfoot>
						<tr style="background-color: #6fdb65; border: 1px solid black;">
							...
							<td colspan="11" style="background-color: #6fdb65;"></td>
							<td id="totalOrderDtlQty" style="background-color: #6fdb65;"></td>
							<td id="totalAlreadyInWhsQty" style="background-color: #6fdb65;"></td>
							<td style="background-color: #6fdb65;"></td>
							<td id="totalOrderQty" style="background-color: #6fdb65;"></td>
							<td style="background-color: #6fdb65;"></td>
							<td id="totalCost" style="background-color: #6fdb65;"></td>
							<td style="background-color: #6fdb65;"></td>
						</tr>
					</tfoot>
				</table>
...
//         scrollX: true,
		...
		drawCallback: function() {
			...
			let totalOrderDtlQty = 0;
			let totalAlreadyInWhsQty = 0;
			let totalOrderQty = 0;
			let totalCost = 0;
			...
			for(var i=0; i<data.length; i++){
				totalOrderDtlQty += parseInt(data[i].orderDtlQty);
				totalAlreadyInWhsQty += parseInt(data[i].alreadyInWhsQty);
				totalOrderQty += parseInt(data[i].orderQty);
				totalCost += parseInt($($('#purchaseOrderAdmTable').DataTable().row(i).node()).find('div[name=totalAmt]').text());
			}
			...
			$('#totalOrderDtlQty').text(addCommas(totalOrderDtlQty));
			$('#totalAlreadyInWhsQty').text(addCommas(totalAlreadyInWhsQty));
			$('#totalOrderQty').text(addCommas(totalOrderQty));
			$('#totalCost').text(addCommas(totalCost));
