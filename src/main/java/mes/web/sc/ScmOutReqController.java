...
import mes.service.sc.ScmOutReqService;
...
@Controller
public class ScmOutReqController {
	
	@Inject
	private ScmOutReqService outReqService;
	...
	// bssc0150 페이지
	@RequestMapping(value = "/sc/scsc0150", method = RequestMethod.GET)
	public ModelAndView bssc0130(ModelAndView mav, HttpServletRequest request) {
		logger.info("page : /sc/scsc0150");
		mav.setViewName("/sc/scsc0150");
		return mav;
	}
	
	// =========================== 출고등록 메인 ==========================================
	// 출고등록 메인 목록조회
	@RequestMapping(value = "sc/bizOrderOutReqLst", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> bizOrderOutReqLst(SupplyChainManagementVo bizOrderVo) throws Exception {
		Map<String, Object> jsonData = new HashMap<String, Object>();
		logger.info("출고등록 메인 목록조회");
		try {
			List<SupplyChainManagementVo> bizOrderOutReqLst = outReqService.bizOrderOutReqLst(bizOrderVo);
	...
	// =========================== 출고등록 출고처리 ==========================================
	// 출고등록 출고처리 메인 목록조회
	@RequestMapping(value = "sc/outReqAdmLst", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> bizOrderoutReqAdmLstOutReqLst(SupplyChainManagementVo bizOrderVo) throws Exception {
		Map<String, Object> jsonData = new HashMap<String, Object>();
		logger.info("출고등록 출고처리 메인 목록조회");
		try {
			List<SupplyChainManagementVo> outReqAdmLst = outReqService.outReqAdmLst(bizOrderVo);
...
//	// 출고처리
//	@RequestMapping(value = "sc/outReqAdmIU", method = RequestMethod.POST)
...
//			
//			List<ScmBizOrderVo> outReqAdmInsertList = new ArrayList<>();
//			List<ScmBizOrderVo> outReqAdmUpdateList = new ArrayList<>();
//			
...
//	    		ScmBizOrderVo bizOrderVo = new ScmBizOrderVo();
//	    		
...
//	
//	// 출고처리 삭제
//	@RequestMapping(value = "sc/outReqAdmDel", method = RequestMethod.POST)
//	public @ResponseBody Map<String, Object> outReqAdmDel(ScmBizOrderVo bizOrderVo) throws Exception {
//		Map<String, Object> jsonData = new HashMap<String, Object>();
//		logger.info("출고처리 삭제");
//		try {
//			bizOrderVo.setUpdIdx(Utils.getUserIdx());
...
//	// =========================== 출고처리 Serial No ==========================================
//	//  출고처리 Serial No 목록조회
//	@RequestMapping(value = "sc/outReqDtlLst", method = RequestMethod.POST)
//	public @ResponseBody Map<String, Object> outReqDtlLst(ScmBizOrderVo bizOrderVo) throws Exception {
//		Map<String, Object> jsonData = new HashMap<String, Object>();
//		logger.info(" 출고처리 Serial No 목록조회");
//		try {
//			List<ScmBizOrderVo> outReqDtlLst = outReqService.outReqDtlLst(bizOrderVo);
...
//	
//	// Serial No 등록/수정
//	@RequestMapping(value = "sc/outReqDtlIU", method = RequestMethod.POST)
...
//			JSONArray dataArray = (JSONArray) jsonParser.parse(jsonArray);
//			
//			List<ScmBizOrderVo> outReqDtlInsertList = new ArrayList<>();
//			List<ScmBizOrderVo> outReqDtlUpdateList = new ArrayList<>();
//			
//			JSONObject jsonObj = new JSONObject();
//			int dtlSeq = 1;
//	        for(int i=0;i<dataArray.size();i++) {
...
//	
//	// Serial No 삭제
//	@RequestMapping(value = "sc/outReqDtlDel", method = RequestMethod.POST)
//	public @ResponseBody Map<String, Object> outReqDtlDel(ScmBizOrderVo bizOrderVo) throws Exception {
//		Map<String, Object> jsonData = new HashMap<String, Object>();
...
//	
//	// CS등록 Serial No 목록조회
//	@RequestMapping(value = "sc/outReqDtlSerialLst", method = RequestMethod.POST)
//	public @ResponseBody Map<String, Object> outReqDtlSerialLst(ScmBizOrderVo bizOrderVo) throws Exception {
//		Map<String, Object> jsonData = new HashMap<String, Object>();
//		logger.info(" 출고처리 Serial No 목록조회");
//		try {
//			List<ScmBizOrderVo> outReqDtlLst = outReqService.outReqDtlSerialLst(bizOrderVo);
//			jsonData.put("data", outReqDtlLst);
//			jsonData.put("result", "ok");
//		} catch (Exception e) {
//			e.printStackTrace();
